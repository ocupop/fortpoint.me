...
<div class="page-header">
  <h1>We are a business law firm that represents clients ranging from emerging growth companies to large, established enterprises across a wide range of industries.</h1>
</div>
  ...
  <figure class="slider">
    <ul id="slides">
      <li class="current">
        ...
        <div class="wrapper">
          <figcaption>
            The jQuery Foundation is the official steward of the popular JavaScript library. We help guide the Foundation as it pursues its goals of developing and supporting this important open source project.
          </figcaption>
        </div>
